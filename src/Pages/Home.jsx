    ...
    <>
              ...
              <div className="col-md-4">
                <div className="text-md-center">
                  ...
                  <p className="mb-4 m-md-0">
                    Forest Bazar near agriculture University
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="text-md-center">
                  ...
                  <p className="mb-4 m-md-0">muhsinoptimist123@gmail.com</p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="text-md-center">
                  ...
                  <p className="m-0">+923299884676</p>
                </div>
              </div>
            </div>
          </div>
      ...
      >
        <p className="m-0 text-white">
          ...
          <a href="https://github.com/MohsinAhmad01">Mohsin Ahmad</a>
        </p>
      </div>
      {/* Footer End */}
      {/* Modal */}
